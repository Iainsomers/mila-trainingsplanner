...
from core.views.coach import (
    ...
    coach_tools_view,
    evaluations_view,
    evaluation_fill_view,
    match_overview_view,
    match_overview_create_view,
    match_overview_delete_view,
    match_overview_detail_view,
    pr_database_view,
    pr_database_import_view,
    pr_database_detail_view,
    ...
    year_planner_whereabout_save_view,
    trainer_stats_view,
...
urlpatterns = [
    ...
    path("evaluations/<int:questionnaire_id>/", evaluation_fill_view, name="evaluation_fill"),
    path("coach-tools/match-overview/", match_overview_view, name="match_overview"),
    path("coach-tools/match-overview/new/", match_overview_create_view, name="match_overview_create"),
    path("coach-tools/match-overview/<int:match_id>/delete/", match_overview_delete_view, name="match_overview_delete"),
    path("coach-tools/match-overview/<int:match_id>/", match_overview_detail_view, name="match_overview_detail"),
    path("coach-tools/pr-database/", pr_database_view, name="pr_database"),
    path("coach-tools/pr-database/add-pbs/", pr_database_import_view, name="pr_database_import"),
    path("coach-tools/pr-database/<int:record_id>/", pr_database_detail_view, name="pr_database_detail"),
